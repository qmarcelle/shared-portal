export const condensedExperienceProfileHorizonGroups: string[] = ['130430'];
export const katieBeckettGroups: string[] = ['155000'];
...
export const hideManageMyPlanGroups: string[] = [];
