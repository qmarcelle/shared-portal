              ...
              relatedPersons: [
                {
                  ...
                  relatedPersonRelationshipTermDate: '2030-11-30T00:00:00',
                  relatedPersonRoleType: 'Subscriber',
                  relatedPersonDob: '2030-11-30T00:00:00',
...
describe('Non Member Dashboard', () => {
  ...
  it('should render correctly with all avail switch roles', () => {
    expect(screen.getByText('Raphel Claud')).toBeVisible();
