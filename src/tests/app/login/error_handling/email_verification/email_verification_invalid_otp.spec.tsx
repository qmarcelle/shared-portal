...
describe('Log In of User whose Email Id is not registered yet - Brand Error Message Scenarios', () => {
  afterEach(() => {
  ...
  it('Email Registration is failed with invalid otp', async () => {
    mockedAxios.post
      ...
      .mockRejectedValueOnce(
        createAxiosErrorForTest({
          errorObject: { data: { errorCode: 'MF-402' } },
          status: 400,
        }),
      );
  ...
  it('Email Registration is throwing Account_Inactive', async () => {
    mockedAxios.post
      .mockResolvedValueOnce({
        // call to /login
        data: {
  ...
  it('Email Registration return 200 status but data is undefined', async () => {
    mockedAxios.post
      .mockResolvedValueOnce({
        // call to /login
        data: {
