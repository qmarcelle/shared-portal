...
//jest.mock('../../../../../a../((common)/login/stores/verifyEmailStore');
...
describe('Email Uniqueness resend code - Http Error 500', () => {
  afterEach(() => {
    resetToHome();
  });
  test('Email uniqueness resend code 500 http error code', async () => {
