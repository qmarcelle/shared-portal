...
import { fusionSearchResultsEmptyMockResp } from '@/mock/fusion_search/fusionSearchResultsEmptyMockResp';
...
mockedAxios.get.mockResolvedValueOnce({
  data: fusionSearchResultsEmptyMockResp,
});

describe('Search Results Page', () => {
  it('should show all the results correctly on searching from search bar', async () => {
