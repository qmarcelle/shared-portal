...
describe('Request Full Access to Member - requestMemberAccess', () => {
  beforeEach(() => {
  ...
  it('should show plan member details and changes in access request', async () => {
    mockedFetch
    ...
    fireEvent.click(screen.getByText('Request Full Access'));
    expect(
