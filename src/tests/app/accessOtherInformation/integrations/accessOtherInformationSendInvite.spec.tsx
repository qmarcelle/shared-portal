  ...
  it('send invite API call- Success Scenario', async () => {
    ...
    await waitFor(() => {
      expect(mockedAxios.get).toHaveBeenCalledWith(
        '/userRegistration/sharePermission/sendInvite?memeck=147235702&requesteeFHRID=ddd94652-d077-454d-b252-bcb7c24e1de5&requesteeEmailID=testuser@bcbst.com&requestType=Access',
      );
    });
    await waitFor(() => {
      expect(
