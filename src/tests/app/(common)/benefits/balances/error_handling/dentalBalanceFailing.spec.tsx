...
describe('Medical and Dental Balances Error Handling', () => {
  mockedAxios.get
    // dental
  ...
  it('should call Balances api and render error for Dental Balance Section', async () => {
