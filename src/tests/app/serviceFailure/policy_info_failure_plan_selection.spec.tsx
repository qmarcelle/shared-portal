...
describe('Site Header - policy info Service Failure to populate the plan information', () => {
...
describe('Dashboard - policy info Service Failure to populate the plan information', () => {
  let containerSnap: HTMLElement;
  beforeAll(async () => {
