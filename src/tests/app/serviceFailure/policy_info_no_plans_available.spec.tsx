...
describe('Dashboard - policy info Service Failure to populate the plan information when there is no active or termed plan associated.', () => {
...
describe('Dashboard - policy info Service Failure to populate the plan information when there is no active member in Facets', () => {
  let containerSnap: HTMLElement;
  mockedAxios.get.mockResolvedValueOnce({
    data: {
      error: [
        {
          errorCode: 'MPI-404-2',
          error: 'One or more members not found in Facets',
        },
      ],
      currentPolicies: [],
      pastPolicies: [],
