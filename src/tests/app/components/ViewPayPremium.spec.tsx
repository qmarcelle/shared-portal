...
describe('Pay Premium component API and SSO integration', () => {
  it('should show pament due and current balance info Pay Premium Api call ', async () => {
    ...
    mockedAxios.get.mockResolvedValueOnce({
      data: {
        paymentDue: '06/10/2023',
        currentBalance: '1000.46',
        currentStmtBalance: '',
      },
    });
    ...
    expect(screen.getByText('06/10/2023')).toBeVisible();
