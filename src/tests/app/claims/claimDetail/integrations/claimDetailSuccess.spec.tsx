...
(process.env.NEXT_PUBLIC_IDP_VITALSPRP =
  'https://tennessee-uat.prs.mdxdata.com/simplesaml/module.php/saml/sp/metadata.php/vitals-tennessee-ping-sp'),
  ((process.env.NEXT_PUBLIC_VITALS_PRP_SSO_TARGET =
