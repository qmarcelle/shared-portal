...
describe('Other Profile Settngs - NCQA Survey', () => {
  it('NCQA Survey - Update Ethinicity Response', async () => {
    ...
    const newSelectedEthinicity = screen.getByLabelText(
      /Not Hispanic or Latino/i,
    );
    fireEvent.click(newSelectedEthinicity);
    expect(newSelectedEthinicity).toBeChecked();
