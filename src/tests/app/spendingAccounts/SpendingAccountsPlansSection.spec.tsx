import { default as SpendingAccountPage } from '@/app/spendingAccounts/page';
...
const setupUI = async () => {
  const page = await SpendingAccountPage();
  return render(page);
};
...
describe('TransactionCardSection', () => {
  ...
  it('should render UI correctly for mobile device', async () => {
    mockedFetch.mockResolvedValueOnce(
      fetchRespWrapper({
        isActive: true,
        subscriberLoggedIn: true,
