...
export const OnOffLabel = ({ className = '', enabled }: OnOffLabelProps) => {
    ...
    return <div className={`on-off justify-center items-center body-2 flex flex-row ${className}`.trimEnd()} style={{ minWidth: 40, height: 24, ...(enabled ? enabledStyle : disabledStyle) }}>
        <div>
            {enabled ? (
