...
export const SpendingAccountSummary = ({
    className,dateOfAccessingPortal,amountPaid,totalBilledAmount,amountSaved,amountSavedPercentage,color1,color2 }: SpendingSummarySectionProps) => {
    return <Card className={className}>
        <div>
            ...
            <Spacer size={18} />
            <SpendingChart color1={color1} color2={color2} totalAmount={totalBilledAmount} percentageAmountSaved={amountSavedPercentage}></SpendingChart>
            <Row>
                <Circle width={20} height={20} color="#005EB9" radius={50} top={3} right={0}/>
                <TextBox text="You Paid" className="ml-2"/>
                <p className="font-bold ml-auto">${amountPaid}</p>
            </Row>
            <Spacer size={18} />
            <Row>
                <Circle width={20} height={20} color="#5DC1FD" radius={50} top={3} right={0}/>
