...
export const PriorAuthCard = ({ member, dateOfVisit, priorAuthStatus, priorAuthName,priorAuthType}: PriorAuthCardProps) => {
...
return <Card className="cursor-pointer" type="elevated" key={priorAuthName+priorAuthType}>
                            <div className=" flex-row align-top m-4" >
                                <div className="flex" >
                                    <Image src={MedicalIcon} className='icon' alt='Medical' />
                                    <Spacer axis="horizontal" size={8} />
                                    <span className="font-bold" style={{ color: 'var(--primary-color)' }} >{priorAuthName}</span>
                                </div>
                                <Spacer size={16} />
                                <div className="flex flex-col items-start" >
                                    <StatusLabel label={priorAuthStatus} status={getSuccessStatus()} />
                                    <Spacer size={8} />
                                    <span className="body-1" >Visited on {dateOfVisit}, For {member}</span>
                            </div>
                            </div>
