import { MyHealthCard } from '@/app/(protected)/(common)/member/myhealth/components/MyHealthCard';
import { MyHealthWellnessHealthLibInfo } from '@/app/(protected)/(common)/member/myhealth/models/app/myheath_wellness_healthlib_options';
...
interface HealthLibraryProps extends IComponent {
  options: MyHealthWellnessHealthLibInfo[];
}

export default function HealthLibraryPage() {
  // TODO: Fetch options from API
  const options: MyHealthWellnessHealthLibInfo[] = [];
