    ...
    <section>
      <Column className="md:ml-10 p-5">
        ...
        <section className="md:flex md:flex-row">
          <Column>
            <Image src="/assets/number_step_one.svg" alt="numberStepOne" />
            <Spacer size={16} />
          </Column>
        ...
        <section className="md:flex md:flex-row">
          <Column>
            <Image src="/assets/number_step_two.svg" alt="numberStepTwo" />
            <Spacer size={16} />
          </Column>
          <Spacer size={32} axis="horizontal" />
          <Column>
        ...
        <section className="md:flex md:flex-row">
          <Column>
            <Image src="/assets/number_step_three.svg" alt="numberStepthree" />
            <Spacer size={16} />
          </Column>
          <Spacer size={32} axis="horizontal" />
          <Column>
      ...
      <section className="md:flex md:flex-row ml-7">
        <Image src="/assets/wellframe.svg" alt="wellframe" />
        <Spacer size={16} />
