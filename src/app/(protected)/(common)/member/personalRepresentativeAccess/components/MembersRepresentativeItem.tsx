import { InviteToRegister } from '@/app/(protected)/(common)/member/personalRepresentativeAccess/journeys/InviteToRegister';
...
import editIcon from '/assets/edit.svg'; // Confirmed correct path and file exists
