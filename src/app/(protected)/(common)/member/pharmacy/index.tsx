                    ...
                    <PharmacyDocuments
                      linkDetails={[
                        ...
                        },
                        {
                          ...
                          linkURL:
                            'http://www.bcbst.com/do../((common)/pharmacy/go-510.pdf',
                          linkIcon: (
                            <Image
                              src={downloadIcon}
                              alt="download Icon"
                        ...
                        <PharmacyFAQ
                          ...
                          services={[
                            ...
                            },
                            {
                              ...
                              answerline1: `If your doctor prescribes a drug that needs a prior authorization, they'll ask us for one when they write your prescription. We'll review the case, make sure the drug is appropriate and safe, and make a decision. If it's approved, we'll send you a letter to let you know. Then you'll be able to get your drugs from the pharmacy.`,
                              answerline2: '',
                            },
                            {
                          ...
                          services={[
                            {
                              ...
                              answerline1: `CVS Caremark helps BlueCross manage your pharmacy benefits, but you don't have to go to a CVS retail pharmacy.`,
                              answerline2: '',
                            },
                            {
                              serviceLabel:
                                'Why should I use a mail order pharmacy for any of my prescriptions?',
                              answerline1: `Getting the drugs you take every day to manage your health from a mail order pharmacy can save you time and money. You won't have to make trips to the pharmacy, and you can get 90-day fills of many drugs. That can lower your cost and make it easier to avoid running out of your medications, which can keep you healthier.`,
                              answerline2: (
                                <RichText
                                  className="manage-image"
                                  spans={[
                            ...
                            {
                              serviceLabel: `I've created my caremark.com account but I can't see prescription info for my teenage dependents. How can I do that?`,
                              answerline1: `To view and manage prescription information for dependents age 13-18, they'll need to create their own caremark.com account. After doing so, they can then grant you to access to manage their mail order prescriptions and see claims history.`,
                              answerline2:
