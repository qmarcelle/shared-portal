  ...
  const faqInformationDetails = [
    {
      ...
      iconName: benefits,
      link: '../((common)/support/faqTopics?faqtype=${encodeURIComponent(FaqTopicType.BenefitsAndCoverage)}',
    },
    {
      label: 'Claims',
      description: 'Learn more about claims or how to file a dispute.',
      iconName: claimsBenefitsCoverage,
      link: '../((common)/support/faqTopics?faqtype=Claims',
    },
    {
      label: 'ID Cards',
      description:
      ...
      link: '../((common)/support/faqTopics?faqtype=ID Cards',
    },
    {
      label: 'My Plan Information',
      description: 'How to update your address, dependents, and more.',
      iconName: enrollment,
      link: '../((common)/support/faqTopics?faqtype=${encodeURIComponent(FaqTopicType.MyPlanInformation)}',
    },
    {
      label: 'Pharmacy',
      description:
      ...
      link: '../((common)/support/faqTopics?faqtype=Pharmacy',
    },
    {
      ...
      link: '../((common)/support/faqTopics?faqtype=${encodeURIComponent(FaqTopicType.PriorAuthorization)}',
    },
    {
      label: 'Security',
      description:
      ...
      iconName: keyIcon,
      link: '../((common)/support/faqTopics?faqtype=${encodeURIComponent(FaqTopicType.SharingPermisionsSecurity)}',
    },
  ];
