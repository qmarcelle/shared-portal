      ...
      faqTopCardDetails: [
        {
          ...
          para1: (
            <RichText
              spans={[
                <span key={0}>
                  Here&apos;s a quick definition for the most common terms
                  you&apos;ll see in insurance:
                  <br />
                </span>,
                ...
                <span key={8}>
                  The percentage of costs for care that you&apos;ll pay —
                  usually after you&apos;ve paid your deductible.
                  <br />
                </span>,
                <span key={9}>
        ...
        },
        {
          ...
          para1: (
            <p className="body-1">
              A network is a group of doctors we work with to provide care to
              our members. Providers in our network agree to offer our members a
              discount. Providers who aren&apos;t in our network don&apos;t
              offer that discount, so their rates are higher.
            </p>
          ),
          bulletPoints: [],
          para2: (
            <p className="body-1">
              To find your network, look at the front of your Member ID card.
              It&apos;s most likely on the bottom left corner.
            </p>
          ),
        },
        {
          ...
          para1: (
            <RichText
              spans={[
                ...
                <span key={2}>
                  . Either search the provider&apos;s name and check which
                  networks they&apos;re in, or search for providers near you and
                  filter your results by your network. If you are logged in,
                  your search results will automatically list providers in your
                  network.
                </span>,
              ]}
            />
        ...
        },
        {
          ...
          para1: (
            <p className="body-1">
              That depends on your plan benefits. For most plans, if you see a
              provider who is not in your network, you will likely be paying
              toward your out-of-network deductible and coinsurance. In that
              case, we typically pay the amount that we&apos;d pay a provider
              who is in your network, according to your out-of-network
              deductible and coinsurance. You&apos;ll pay whatever is left on
              your bill.
            </p>
          ),
          bulletPoints: [],
          para2: (
            <p className="body-1">
              Please keep in mind that some plans, like those on Healthcare.gov
              or through TennCare, don&apos;t pay for providers who aren&apos;t
            ...
            <RichText
              spans={[
                ...
                <span key={3}>
                  ...
                  networks while you&apos;re traveling. If you see a small
                  suitcase icon on your Member ID card, then you have Global
                  Core. If you&apos;re planning a trip and have specific
                  questions, the best thing to do is call Global Core directly
                  at 1-800-810-2583. They&apos;re ready to help you.
                  <br />
                </span>,
                ...
                <span key={14}>
                  <Link href="/emergency-care" className="link font-bold">
                    true emergency
                  </Link>
                  .
                </span>,
