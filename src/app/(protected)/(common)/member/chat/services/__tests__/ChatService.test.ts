import { ChatDataPayload, ChatError } from '@/app/(protected)/(common)/member/chat/types/index';
  ...
  describe('ChatService Implementation', () => {
    describe('getChatInfo', () => {
      it('should fetch chat info successfully', async () => {
        ...
        expect(global.fetch).toHaveBeenCalledWith('/a../((common)/chat/info');
      });
    ...
    describe('startChat', () => {
      it('should start chat successfully', async () => {
        ...
        expect(global.fetch).toHaveBeenCalledWith('/a../((common)/chat/start', {
          method: 'POST',
          headers: {
    ...
    describe('endChat', () => {
      it('should end chat successfully', async () => {
        ...
        expect(global.fetch).toHaveBeenCalledWith('/a../((common)/chat/end', {
          method: 'POST',
        });
      });
    ...
    describe('sendMessage', () => {
      it('should send message successfully', async () => {
        ...
        expect(global.fetch).toHaveBeenCalledWith('/a../((common)/chat/message', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
