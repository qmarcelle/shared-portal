import { useChat } from '@/app/(protected)/(common)/member/chat/hooks/useChat';
import { useChatEligibility } from '@/app/(protected)/(common)/member/chat/hooks/useChatEligibility';
...
jest.mock('@/app/(common)/chat/hooks/useChatEligibility');
