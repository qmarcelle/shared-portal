...
describe('ChatEligibility', () => {
  ...
  it('should not render ChatProvider when user is not authenticated', () => {
  ...
  it('should render ChatProvider when user is authenticated with a plan', () => {
    (useSession as jest.Mock).mockReturnValue({
      data: { 
        user: { 
          currUsr: { 
  ...
  it('should handle plan switching and update eligibility', () => {
    ...
    // This test verifies that the ChatProvider renders correctly
