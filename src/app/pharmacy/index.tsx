...
const Pharmacy = ({ data, visibilityRules }: PharmacyProps) => {
                              ...
                              <RichText
                                ...
                                spans={[
                                  <span key={0}>
                                    ...
                                    some drugs via mail, which can save you time
                                    and money compared to picking up smaller
                                    amounts every month. To start getting your
