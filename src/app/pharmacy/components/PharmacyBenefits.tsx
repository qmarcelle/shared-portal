...
const PharmacyBenefits = ({
  ...
  isFreedomMember: boolean;
}) => {
  return (
    <Card className="large-section">
      <section>
        <Header
          text="Pharmacy Benefits"
          className={`title-2 ${isFreedomMember ? '' : 'font-bold'}`}
        />
        <Spacer size={16} />
        {!isFreedomMember ? (
          <>
          ...
          <>
            <TextBox text="Your plan does not include Medicare Part D prescription drug coverage. Please consult your Evidence of Coverage (EOC) for more information on medical benefits." />
            <Spacer size={16} />
            <AppLink
