 ...
 *
 * This file configures the Genesys chat widget for both cloud and on-premises implementations.
 * It is loaded before chat.js to ensure proper initialization of the chat system.
 *
 * Integration Points:
 * - Loaded by GenesysInitializer.tsx component
 * - Used by ChatProviderFactory to determine chat implementation
...
window.GenesysJS = window.GenesysJS || {};

// Set required deployment parameters
window.GenesysJS.environment = 'us-east-1';
window.GenesysJS.deploymentId = 'web-chat';
